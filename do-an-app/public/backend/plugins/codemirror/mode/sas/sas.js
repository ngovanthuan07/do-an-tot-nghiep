  ...
  CodeMirror.defineMode("sas", function () {
    ...
    return {
      ...
      token: function (stream, state) {
        // Strip the spaces, but regex will account-salon for them either way
