...
<div class="wrapper">
    ...
    <!-- Navbar -->
    @include('layout-include.salon.navbar')
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
    @include('layout-include.salon.sidebar')
    ...
    <!-- Main Footer -->
    @include('layout-include.salon.footer')
</div>
...
<script type src="{{asset('/js/common/toastr.js')}}"></script>
