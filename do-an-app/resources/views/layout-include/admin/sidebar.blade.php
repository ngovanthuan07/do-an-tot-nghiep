        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item menu-open">
                    <a href="#" class="nav-link {{request()->is('admin/salons*') ? 'active' : ''}}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route("admin.salons")}}" class="nav-link {{request()->is('admin/salons') ? 'active' : ''}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Danh sách tài khoản</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route("admin.salons.displayAddSalon")}}" class="nav-link {{request()->is('admin/salons/displayAddSalon') ? 'active' : ''}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Thêm tài khoản</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route("admin.salons.displaySalonBlock")}}" class="nav-link {{request()->is('admin/salons/display-salon-block') ? 'active' : ''}}">
                            <i class="far fa-circle nav-icon"></i>
