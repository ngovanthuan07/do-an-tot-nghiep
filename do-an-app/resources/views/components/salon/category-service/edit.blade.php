                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Cập nhật loại dịch vụ</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form id="myForm">
                            <input type="hidden" name="cse_id" value="{{$categoryService->cse_id}}">
                            <div class="card">
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control nice-select sort-select" name="isSelect">
                                                <option value="1" {{$categoryService->isSelect == 1 ? 'selected' : ''}}>Chỉ chọn một</option>
                                                <option value="2" {{$categoryService->isSelect == 2 ? 'selected' : ''}}>Cho phép chọn nhiều</option>
                                            </select>
                                            <div class="invalid-feedback message-error"> </div>
                                        </div>
                                    </div>
...
@push('scripts')
    <script type="module">
        ...
        handleConfirmModal(()=> {
            $.ajax({
                type: "POST",
                url: "{{route('salon.categoryservice.update')}}",
                data: formData,
                processData: false,
                contentType: false,
