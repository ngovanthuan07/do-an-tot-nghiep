                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" rows="10" placeholder="Miêu tả">{{$employee->description}}</textarea>
                                            <div class="invalid-feedback message-error"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div id="service-picture-container">
                                                <img id="service-picture" src="/media/employee/{{$employee->image}}">
                                            </div>
...
@push('scripts')
    <script type="module">
        ...
        handleConfirmModal(()=> {
            $.ajax({
                type: "POST",
                url: "{{route('salon.employee.update')}}",
                data: formData,
                processData: false,
                contentType: false,
        ...
        $("#saveBtn").on("click", function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('salon.employee.validateUpdate')}}",
                data: formData,
                processData: false,
                contentType: false,
                beforeSend: function () {
